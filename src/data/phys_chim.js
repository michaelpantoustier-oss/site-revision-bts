...
export const FICHES_PC = [
  {id:"pc-f1",title:"Structure de l'atome",bloc:"Chimie générale",tags:["atome", "orbitales", "configuration électronique"],duree:"30 min",niveau:"Intermédiaire",qbank:"QB_PC_STRUCTURE_ATOME",contenu:"**Résumé**\nModèle orbital : niveaux K, L, M... ; orbitales s, p, d ; règles de remplissage (Aufbau, Hund, Pauli) ; configuration électronique des éléments.\n\n**Points clés :**\n• Numéro atomique Z = nombre de protons = nombre d'électrons\n• Nombre de masse A = protons + neutrons\n• Règle de l'Aufbau : remplissage par énergie croissante\n• Règle de Hund : remplissage des sous-couches dégénérées\n• Principe de Pauli : 2 électrons max par orbitale (spins opposés)\n• Configuration d'exception : Cu (3d10 4s1), Cr (3d5 4s1)\n\n**Formules :**\n• E_n = -13,6/n² eV (modèle de Bohr)\n• Capacité d'une couche : 2n²\n\n**À retenir :**\n• 1s < 2s < 2p < 3s < 3p < 4s < 3d... (règle de Klechkowski)"},
  {id:"pc-f2",title:"Édifices covalents",bloc:"Chimie générale",tags:["Lewis", "VSEPR", "liaisons", "géométrie"],duree:"30 min",niveau:"Intermédiaire",qbank:"QB_PC_EDIFICES_COVALENTS",contenu:"**Résumé**\nReprésentation de Lewis des molécules ; modèle VSEPR pour la géométrie ; polarité des liaisons et des molécules.\n\n**Points clés :**\n• Liaison covalente = mise en commun de 2 électrons\n• Règle de l'octet (sauf H : duet) et exceptions (PCl5, SF6, BF3)\n• Charge formelle = électrons de valence - libres - liants/2\n• VSEPR : répulsions doublets → géométrie (tétraédrique, trigonale, linéaire)\n• Moment dipolaire μ = q×d ; molécule polaire si dipôles non compensés\n\n**Formules :**\n• μ = q × d (Debye)\n• Électronégativité : F > O > N > Cl > Br > C > H\n\n**À retenir :**\n• Doublets libres répulsent plus que les doublets liants (angle H2O = 104,5°)"},
  {id:"pc-f3",title:"Forces intermoléculaires",bloc:"Chimie générale",tags:["van der Waals", "liaison hydrogène", "interactions"],duree:"25 min",niveau:"Débutant",qbank:"QB_PC_FORCES_INTERMO",contenu:"**Résumé**\nForces intermoléculaires : ion-dipôle, dipôle-dipôle (Keesom), dipôle induit (Debye), London ; liaison hydrogène.\n\n**Points clés :**\n• Forces de London (dispersion) : universelles, croissent avec la masse molaire\n• Forces de Keesom (orientation) : molécules polaires\n• Forces de Debye (induction) : molécule polaire + apolaire\n• Liaison hydrogène : X-H···Y (X,Y = F,O,N) ; forte (~20 kJ/mol)\n• Conséquences : températures d'ébullition élevées de l'eau\n\n**Formules :**\n• E_London est proportionnel à alpha² / r6\n• T_éb H2O = 100°C vs H2S = -61°C (grâce à la liaison H)\n\n**À retenir :**\n• Plus la molécule est polarisable, plus les forces de London sont fortes"},
  {id:"pc-f4",title:"Préparation des solutions",bloc:"Chimie générale",tags:["concentration", "dilution", "dissolution"],duree:"25 min",niveau:"Débutant",qbank:"QB_PC_PREP_SOLUTIONS",contenu:"**Résumé**\nConcentrations massique et molaire ; loi de dilution ; pourcentage massique et volumique.\n\n**Points clés :**\n• Cm = masse soluté / volume solution (g/L)\n• C = n / V = Cm / M (mol/L)\n• Dilution : C1V1 = C2V2 (conservation des moles)\n• Fraction molaire, molalité (mol/kg solvant)\n• Densité d : relier % massique et concentration molaire\n\n**Formules :**\n• n = C × V\n• C = (d × P% × 1000) / M (P% en fraction décimale)\n• C1V1 = C2V2\n\n**À retenir :**\n• Toujours verser l'acide dans l'eau, jamais l'inverse"},
  {id:"pc-f5",title:"Avancement et stœchiométrie",bloc:"Chimie générale",tags:["avancement", "réactif limitant", "stœchiométrie"],duree:"30 min",niveau:"Intermédiaire",qbank:"QB_PC_AVANCEMENT",contenu:"**Résumé**\nTableau d'avancement, réactif limitant, rendement, taux d'avancement.\n\n**Points clés :**\n• Avancement x : varie de 0 à xmax\n• Réactif limitant : celui qui s'épuise en premier (x_max le plus faible)\n• Rendement η = x_final / x_max × 100%\n• Taux d'avancement final : τ = xf / xeq\n• État d'équilibre : avancement x_eq où Q = K\n\n**Formules :**\n• xmax = n_i / ν_i (minimum sur les réactifs)\n• η = n_obtenu / n_théorique × 100\n• τ = x_eq / x_max\n\n**À retenir :**\n• Écrire le tableau n(initial) – ν_i × x pour chaque espèce"},
  {id:"pc-f6",title:"Équilibres chimiques",bloc:"Chimie générale",tags:["Kc", "Kp", "Le Chatelier", "équilibre"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_EQUILIBRES",contenu:"**Résumé**\nConstante d'équilibre Kc et Kp ; quotient réactionnel Q ; principe de Le Chatelier ; équilibres hétérogènes.\n\n**Points clés :**\n• Kc = produit [produits]^ν / [réactifs]^ν (à l'équilibre)\n• Q < K : réaction directe ; Q > K : réaction inverse\n• Principe de Le Chatelier : perturbation → déplacement pour compenser\n• Kp = Kc × (RT)^Δn pour les gaz\n• Solides et solvants purs exclus de K\n\n**Formules :**\n• Kp = Kc(RT)^Δn\n• ln K = -ΔrG°/RT = -ΔrH°/RT + ΔrS°/R\n\n**À retenir :**\n• K > 1 : équilibre favorable aux produits ; K < 1 : aux réactifs"},
  {id:"pc-f7",title:"Thermochimie",bloc:"Chimie générale",tags:["enthalpie", "Hess", "énergie", "thermochimie"],duree:"40 min",niveau:"Intermédiaire",qbank:"QB_PC_THERMOCHIMIE",contenu:"**Résumé**\nLoi de Hess, enthalpies standard de formation et de combustion, enthalpie de liaison.\n\n**Points clés :**\n• Réaction exothermique : ΔrH < 0 ; endothermique : ΔrH > 0\n• Loi de Hess : additivité des enthalpies de réaction\n• ΔrH° = Σ ΔfH°(produits) – Σ ΔfH°(réactifs)\n• Énergie de liaison : énergie à fournir pour rompre 1 mol de liaison\n• Capacité calorifique Cp ; calorimétrie : q = mCpΔT\n\n**Formules :**\n• ΔrH = Σ(liaisons rompues) – Σ(liaisons formées)\n• q = mCpΔT\n• ΔrG° = ΔrH° – TΔrS°\n\n**À retenir :**\n• ΔfH°(éléments stables) = 0 ; ΔfH°(H2O liquide) = -286 kJ/mol"},
  {id:"pc-f8",title:"Acides et bases I",bloc:"Chimie générale",tags:["pH", "acides", "bases", "pKa"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_ACIDES_BASES_1",contenu:"**Résumé**\nDéfinition de Brønsted-Lowry, couples acide-base, pH des acides et bases forts et faibles, Ke.\n\n**Points clés :**\n• Acide de Brønsted : donneur de proton H+\n• Base de Brønsted : accepteur de proton H+\n• Ke = [H3O+][OH-] = 10^-14 à 25°C ; pKe = 14\n• pH = -log[H3O+] ; pOH = 14 – pH\n• Acide fort totalement dissocié : pH = -log(Ca)\n• Acide faible (Ka) : pH = 1/2 × (pKa – log Ca)\n\n**Formules :**\n• Ka = [A-][H3O+] / [AH]\n• pH acide fort = -log Ca ; pH base forte = 14 + log Cb\n• pKa + pKb = pKe = 14\n\n**À retenir :**\n• Demi-neutralisation : pH = pKa"},
  {id:"pc-f9",title:"Acides et bases II",bloc:"Chimie générale",tags:["tampon", "Henderson", "polyprotiques", "isoélectrique"],duree:"35 min",niveau:"Avancé",qbank:"QB_PC_ACIDES_BASES_2",contenu:"**Résumé**\nÉquation de Henderson-Hasselbalch, solutions tampons, acides polyprotiques, pH isoélectrique.\n\n**Points clés :**\n• Henderson-Hasselbalch : pH = pKa + log([A-]/[AH])\n• Solution tampon : résiste aux changements de pH\n• Capacité tampon maximale : [A-] = [AH] → pH = pKa\n• Acide polyprotique : Ka1 >> Ka2 >> Ka3\n• pH isoélectrique pI = (pKa1 + pKa2) / 2 pour acides aminés\n\n**Formules :**\n• pH = pKa + log([A-]/[AH])\n• pI = (pKa_COOH + pKa_NH3+) / 2\n\n**À retenir :**\n• Tampon acide acétique/acétate : pH ≈ 4,75 ± 1"},
  {id:"pc-f10",title:"Conductimétrie",bloc:"Chimie générale",tags:["conductance", "conductimétrie", "Kohlrausch", "dosage"],duree:"30 min",niveau:"Intermédiaire",qbank:"QB_PC_CONDUCTIVITE",contenu:"**Résumé**\nConductance G et résistance R, conductivité σ, conductivité molaire Λm, loi de Kohlrausch, dosages conductimetriques.\n\n**Points clés :**\n• G = 1/R (siemens, S) ; conductivité σ = G × l/S (S/m)\n• Conductivité molaire Λm = σ/C\n• Loi de Kohlrausch : Λm = Λm° – k√C\n• Λm° additivité des conductivités molaires ioniques\n• Mécanisme de Grotthuss : mobilité exceptionnelle de H3O+ et OH-\n• Courbe conductimétrique : changement de pente au point d'équivalence\n\n**Formules :**\n• σ = Σ λi ci |zi|\n• Λm = σ / C\n• Loi de Kohlrausch : Λm = Λm° – k√C\n\n**À retenir :**\n• Eau pure : σ ≈ 5,5 × 10^-6 S/m à 25°C"},
  {id:"pc-f11",title:"Précipitation",bloc:"Chimie générale",tags:["Ks", "précipitation", "solubilité", "Mohr"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_PRECIPITATION",contenu:"**Résumé**\nProduit de solubilité Ks, calcul de solubilité, effets sur la dissolution, titrages par précipitation.\n\n**Points clés :**\n• Ks = [cation]^a × [anion]^b (à l'équilibre de dissolution)\n• Précipitation si Q > Ks\n• Solubilité s : s = (Ks)^(1/(a+b)) pour sel MaXb\n• Effet d'ion commun : diminue la solubilité\n• Méthode de Mohr : Ag+/Cl- avec indicateur CrO4²-\n• Méthode de Volhard : Ag+ puis SCN-, indicateur Fe³+\n\n**Formules :**\n• s(AgCl) = √Ks\n• s(CaF2) = (Ks/4)^(1/3)\n\n**À retenir :**\n• Ks(AgCl) = 1,8 × 10^-10 ; Ks(BaSO4) = 1,1 × 10^-10"},
  {id:"pc-f12",title:"Complexation",bloc:"Chimie générale",tags:["EDTA", "complexe", "chélate", "dosage"],duree:"30 min",niveau:"Intermédiaire",qbank:"QB_PC_COMPLEXATION",contenu:"**Résumé**\nDéfinition des complexes, ligands, constante de stabilité βn, EDTA, dosages complexométriques.\n\n**Points clés :**\n• Complexe = métal central + ligands (donneurs de doublets)\n• Nombre de coordination = nombre de liaisons métal-ligand\n• Ligand mono-, bi-, hexadentate (EDTA)\n• Constante de stabilité βn = [MLn] / ([M][L]^n)\n• Effet chélate : complexes polydentates plus stables\n• EDTA dose Ca²+ et Mg²+ à pH 10 avec indicateur NET\n\n**Formules :**\n• Kf = βn = [MLn] / ([M][L]^n)\n• log β(Ca-EDTA) ≈ 10,7\n\n**À retenir :**\n• Indicateur NET (ériochrome T) : rose avec Ca/Mg, bleu seul"},
  {id:"pc-f13",title:"Oxydoréduction",bloc:"Chimie générale",tags:["redox", "Nernst", "électrochimie", "pile"],duree:"40 min",niveau:"Avancé",qbank:"QB_PC_OXYDOREDUC",contenu:"**Résumé**\nNombres d'oxydation, demi-réactions, loi de Nernst, piles électrochimiques, constante d'équilibre redox.\n\n**Points clés :**\n• Oxydant : accepteur d'électrons ; réducteur : donneur d'électrons\n• Couple Ox/Red : Ox + ne- ⇌ Red\n• Bilan redox : ajuster les électrons transférés\n• E = E° + (0,059/n) × log([Ox]/[Red]) à 25°C\n• FEM = E_cathode – E_anode\n• ΔG° = –nFE° = –RT ln K\n\n**Formules :**\n• E = E° + (0,059/n) log([Ox]/[Red])\n• ΔG° = -nFE°\n• log K = n × E° / 0,059\n\n**À retenir :**\n• E°(O2/H2O) = +1,23 V ; E°(H+/H2) = 0,00 V (référence ENH)"},
  {id:"pc-f14",title:"Cinétique chimique",bloc:"Chimie générale",tags:["cinétique", "ordre", "Arrhenius", "demi-vie"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_CINETIQUE",contenu:"**Résumé**\nLoi de vitesse, ordres de réaction, demi-vie, équation d'Arrhenius, catalyse.\n\n**Points clés :**\n• Vitesse v = k[A]^m[B]^n ; ordre global = m + n\n• Ordre 1 : v = k[A] ; t1/2 = ln2/k (indépendant de C)\n• Ordre 0 : v = k ; t1/2 = [A]0 / (2k)\n• Ordre 2 : v = k[A]² ; t1/2 = 1 / (k[A]0)\n• Arrhenius : k = A × exp(-Ea/RT)\n• Catalyseur : abaisse Ea, ne déplace pas l'équilibre\n\n**Formules :**\n• t1/2 (ordre 1) = ln2/k ≈ 0,693/k\n• ln(k2/k1) = Ea/R × (1/T1 – 1/T2)\n• [A] = [A]0 × e^(-kt) (ordre 1)\n\n**À retenir :**\n• Règle des 10° : k double tous les 10°C environ (Q10 ≈ 2)"},
  {id:"pc-f15",title:"Ondes électromagnétiques",bloc:"Physique",tags:["ondes", "EM", "lumière", "spectre"],duree:"25 min",niveau:"Débutant",qbank:"QB_PC_ONDES_EM",contenu:"**Résumé**\nSpectre électromagnétique, relation c = λν, énergie des photons, applications biologiques.\n\n**Points clés :**\n• c = λ × ν (c = 3 × 10^8 m/s dans le vide)\n• Énergie photon : E = hν = hc/λ (h = 6,63 × 10^-34 J·s)\n• Spectre (λ croissante) : γ, X, UV, visible (400-780 nm), IR, micro-ondes, radio\n• UV-A (315-400 nm), UV-B (280-315 nm), UV-C (<280 nm, germicide)\n• Visible : violet (400) < bleu < vert < jaune < orange < rouge (780 nm)\n\n**Formules :**\n• E = hν = hc/λ\n• c = λν (λ en m, ν en Hz)\n• Nombre d'onde : σ = 1/λ (cm-1)\n\n**À retenir :**\n• UV-C stérilisant car absorbé par l'ADN (bases aromatiques) à ~260 nm"},
  {id:"pc-f16",title:"Spectrométrie d'absorption moléculaire",bloc:"Physique",tags:["Beer-Lambert", "absorbance", "spectrophotométrie", "fluorescence"],duree:"30 min",niveau:"Intermédiaire",qbank:"QB_PC_SPECTROMETRIE",contenu:"**Résumé**\nLoi de Beer-Lambert, absorbance A, transmittance T, longueur d'onde optimale, fluorescence.\n\n**Points clés :**\n• A = ε × l × c (A = log(I0/I) = -log T)\n• ε : coefficient d'extinction molaire (L·mol-1·cm-1)\n• Additivité de Beer-Lambert : A_totale = Σ Ai\n• λmax : absorbance maximale → meilleure sensibilité\n• Fluorescence : absorption hν → émission hν' (λ emission > λ absorption)\n• A260/A280 pour la pureté ADN (ratio pur ≈ 1,8)\n\n**Formules :**\n• A = ε l c\n• T = I/I0 ; A = -log T\n• A260/A280 ADN pur ≈ 1,8 ; ARN ≈ 2,0\n\n**À retenir :**\n• Mesurer à λmax ; préparer un blanc (eau ou solvant) pour zéro absorbance"},
  {id:"pc-f17",title:"Optique géométrique",bloc:"Physique",tags:["réfraction", "lentilles", "microscopie", "optique"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_OPTIQUE",contenu:"**Résumé**\nLois de Descartes, réfraction, lentilles convergentes, microscope optique, résolution.\n\n**Points clés :**\n• Snell-Descartes : n1 sin θ1 = n2 sin θ2\n• Réflexion totale interne : sin θc = n2/n1 (n1 > n2)\n• Vergence V = 1/f' (dioptries) ; 1/OA' – 1/OA = 1/f'\n• Limite de résolution Rayleigh : d = 0,61λ/ON\n• Immersion à l'huile : ON jusqu'à 1,4 ; résolution ~0,2 µm\n• Grossissement total microscope = G_obj × G_oculaire\n\n**Formules :**\n• n1 sin θ1 = n2 sin θ2\n• d = 0,61λ/ON\n• 1/OA' – 1/OA = 1/f'\n\n**À retenir :**\n• Contraste de phase, fond noir, TIRF : techniques pour visualiser sans fluorescence"},
  {id:"pc-f18",title:"Structure et nomenclature des molécules organiques",bloc:"Chimie organique",tags:["nomenclature", "formule", "hybridation", "isomérie"],duree:"30 min",niveau:"Débutant",qbank:"QB_PC_ORGA_STRUCTURE",contenu:"**Résumé**\nRègles de nomenclature IUPAC, hybridations sp/sp2/sp3, isomérie de constitution.\n\n**Points clés :**\n• Chaîne principale = chaîne la plus longue contenant le groupe fonctionnel prioritaire\n• Numérotation : position la plus basse pour les substituants\n• sp3 : tétraédrique 109,5° ; sp2 : trigonal plan 120° ; sp : linéaire 180°\n• Isomérie de constitution : même formule brute, enchaînements différents\n• Priorité des groupes : COOH > COO- > CHO > C=O > OH > NH2\n\n**Formules :**\n• CnH2n+2 alcanes ; CnH2n alcènes/cycloalcanes ; CnH2n-2 alcynes\n• Indice d'insaturation = (2C + 2 + N – H – X) / 2\n\n**À retenir :**\n• Suffixes : -ane, -ène, -yne, -ol, -al (aldéhyde), -one (cétone), -oïque (acide)"},
  {id:"pc-f19",title:"Stéréochimie",bloc:"Chimie organique",tags:["chiralité", "énantiomères", "diastéréoisomères", "R/S", "E/Z"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_ORGA_STEREO",contenu:"**Résumé**\nChiralité, carbone asymétrique, configurations R/S et E/Z, énantiomères, diastéréoisomères, composés méso.\n\n**Points clés :**\n• Carbone asymétrique C* : 4 substituants différents\n• Configuration absolue R/S : règles de Cahn-Ingold-Prelog (CIP)\n• Énantiomères : images miroir non superposables → même propriétés sauf activité optique\n• Diastéréoisomères : propriétés physiques différentes\n• E/Z (géométrie alcènes) : E si groupes prioritaires opposés\n• Mélange racémique : 50/50, [α] = 0 ; composé méso : plan de symétrie\n\n**Formules :**\n• [α] = α / (c × l) (polarimétrie)\n• Nombre max stéréoisomères = 2^n (n = nb de C*)\n\n**À retenir :**\n• Règle CIP : H priorité la plus basse ; sens 1→2→3 donne R (horaire) ou S (antihoraire)"},
  {id:"pc-f20",title:"Effets électroniques",bloc:"Chimie organique",tags:["inductif", "mésomère", "résonance", "acidité", "basicité"],duree:"30 min",niveau:"Avancé",qbank:"QB_PC_ORGA_EFFETS_ELEC",contenu:"**Résumé**\nEffets inductif (+I/-I) et mésomère (+M/-M), stabilisation des intermédiaires, acidité et basicité.\n\n**Points clés :**\n• Effet -I : attracteurs (halogènes, OH, NO2) ; +I : alkyles\n• Effet -M : attracteurs conjugués (C=O, NO2) ; +M : donneurs (O, N)\n• Carbocation stabilisé par effets +I, +M : 3° > 2° > 1° > méthyle\n• Carbanion stabilisé par effets -I, -M\n• Plus la base conjuguée est stable, plus l'acide est fort\n• Aniline : doublet de N délocalisé → base plus faible qu'alkylamine\n\n**Formules :**\n• pKa(CH3COOH) = 4,75 ; pKa(CCl3COOH) = 0,7\n• pKa(PhOH) = 10 ; pKa(EtOH) = 16\n\n**À retenir :**\n• Acidité : analyser la stabilité de l'anion ; basicité : disponibilité du doublet"},
  {id:"pc-f21",title:"Alcools et phénols",bloc:"Chimie organique",tags:["alcools", "oxydation", "élimination", "ester", "phénol"],duree:"30 min",niveau:"Intermédiaire",qbank:"QB_PC_ORGA_ALCOOLS",contenu:"**Résumé**\nRéactivité des alcools : oxydation, élimination, estérification ; propriétés des phénols.\n\n**Points clés :**\n• Alcool 1° → aldéhyde (ménagé) → acide carboxylique (excès oxydant)\n• Alcool 2° → cétone\n• Alcool 3° : résistant à l'oxydation douce\n• Déshydratation intramoléculaire → alcène (Zaitsev)\n• Déshydratation intermoléculaire → éther R-O-R'\n• Estérification : ROH + RCOOH → ester + H2O (lente, réversible)\n• Phénol : pKa ≈ 10 (acidité due à la résonance avec le cycle)\n\n**Formules :**\n• CrO3/H2SO4 (réactif de Jones) : alcool 1° → COOH ; 2° → cétone\n• PCC : alcool 1° → aldéhyde seulement\n\n**À retenir :**\n• Test de Lucas (ZnCl2/HCl) : 3° réagit immédiatement, 2° en quelques min, 1° ne réagit pas"},
  {id:"pc-f22",title:"Aldéhydes et cétones",bloc:"Chimie organique",tags:["carbonyle", "addition nucléophile", "Grignard", "réduction", "Fehling"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_ORGA_CARBONYLES",contenu:"**Résumé**\nRéactivité du groupe carbonyle : addition nucléophile, Grignard, réductions, condensations, tautomérie.\n\n**Points clés :**\n• Addition nucléophile sur C=O : Nu- attaque le C delta+\n• Grignard sur aldéhyde → alcool secondaire ; sur cétone → alcool tertiaire\n• NaBH4 réduit aldéhydes et cétones en alcools\n• Test Fehling (Cu2+) : positif avec aldéhydes seulement (précipité rouge Cu2O)\n• Test 2,4-DNPH : positif avec aldéhydes ET cétones\n• Tautomérie céto-énolique ; condensation aldolique (énolate + carbonyle)\n\n**Formules :**\n• Test Tollens : Ag+ → Ag° (miroir d'argent) avec aldéhydes\n• Wittig : carbonyle + ylure → alcène C=C\n\n**À retenir :**\n• Fehling/Tollens distinguent aldéhydes des cétones (cétones ne réduisent pas)"},
  {id:"pc-f23",title:"Dérivés d'acides carboxyliques",bloc:"Chimie organique",tags:["ester", "amide", "acide carboxylique", "estérification", "saponification"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_ORGA_DERIVES_ACIDES",contenu:"**Résumé**\nRéactivité des dérivés d'acides : esters, amides, anhydrides, chlorures d'acyle ; estérification, saponification.\n\n**Points clés :**\n• Ordre réactivité : chlorure d'acyle > anhydride > ester > amide\n• Estérification : lente, réversible, Keq ≈ 1-10 (catalyse H+)\n• Saponification : totale, irréversible (NaOH) → carboxylate\n• Amide : résonance N→CO rend l'hydrolyse difficile\n• Liaison peptidique = amide entre acides aminés (-CO-NH-)\n• Anhydride acétique : acétylation des -OH et -NH2\n\n**Formules :**\n• Keq(estérification) = [ester][eau] / [alcool][acide]\n• Boc-NH → NH2 (TFA) ; Fmoc-NH → NH2 (pipéridine)\n\n**À retenir :**\n• Aspirine = ester acétylsalicylique ; hydrolysée par la muqueuse gastrique"},
  {id:"pc-f24",title:"Spectroscopie des molécules organiques",bloc:"Chimie organique",tags:["IR", "RMN", "spectrométrie de masse", "analyse structurale"],duree:"40 min",niveau:"Avancé",qbank:"QB_PC_ORGA_SPECTRO",contenu:"**Résumé**\nIR (groupes fonctionnels), RMN 1H et 13C (déplacements chimiques, couplage), spectrométrie de masse.\n\n**Points clés :**\n• IR C=O : ester ~1735, cétone ~1715, acide ~1710, amide ~1680 cm-1\n• IR O-H acide carboxylique : large bande 2500-3300 cm-1\n• RMN 1H : ArH 6-8 ppm ; CHO ~9-10 ppm ; COOH ~10-12 ppm\n• Règle n+1 : n voisins → n+1 raies (multiplet)\n• Spectrométrie de masse : M+ ion moléculaire ; perte de 15 = CH3, 28 = CO\n• Indice d'insaturation = (2C + 2 + N – H – X) / 2\n\n**Formules :**\n• δ (ppm) = (ν_signal – ν_TMS) / ν_spectromètre × 10^6\n• A = εlc (Beer-Lambert)\n\n**À retenir :**\n• Référence RMN : TMS à δ = 0 ppm ; découplé 13C → un singulet par carbone"},
  {id:"pc-f25",title:"Alcènes et alcanes – réactivité",bloc:"Chimie organique",tags:["alcènes", "addition", "élimination", "Markovnikov", "Zaitsev"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_ORGA_ALCANES_ALCENES",contenu:"**Résumé**\nRéactions des alcanes (substitution radicalaire) et des alcènes (additions électrophiles, oxydations).\n\n**Points clés :**\n• Alcanes : bromation/chloration radicalaire (UV ou chaleur) ; sélectivité Br > Cl\n• Alcènes : addition électrophile de HX selon la règle de Markovnikov\n• Addition de Br2 : anti via ion bromonium → trans-dibromure\n• Hydratation H2SO4/H2O : alcool selon Markovnikov\n• Hydroboration : addition syn anti-Markovnikov\n• Ozonolyse : clive C=C en deux composés carbonylés\n• Dihydroxylation syn (KMnO4 froid ou OsO4)\n\n**Formules :**\n• Markovnikov : H sur C qui porte le plus de H (carbocation le plus stable)\n• Zaitsev : alcène le plus substitué lors d'élimination E2\n\n**À retenir :**\n• Hydroboration-oxydation = syn + anti-Markovnikov (OH sur C le moins substitué)"},
  {id:"pc-f26",title:"Composés aromatiques",bloc:"Chimie organique",tags:["aromaticité", "Hückel", "SEAr", "orientation", "benzène"],duree:"35 min",niveau:"Intermédiaire",qbank:"QB_PC_ORGA_AROMATIQUES",contenu:"**Résumé**\nAromaticité (règle de Hückel), substitution électrophile aromatique (SEAr), orientation des substituants.\n\n**Points clés :**\n• Hückel : 4n+2 électrons π (benzène 6e-, naphtalène 10e-)\n• SEAr : halogénation (AlX3), nitration (HNO3/H2SO4), Friedel-Crafts\n• Groupes activants ortho/para (+M) : OH, OR, NR2, alkyles\n• Groupes désactivants méta (-M, -I) : NO2, COOH, CHO, CF3\n• Phénol pKa ≈ 10 ; aniline base faible (résonance N→cycle)\n• Oxydation de la chaîne alkyle : KMnO4 chaud → acide benzoïque\n\n**Formules :**\n• Règle de Hückel : 4n+2 e- π (n = 0, 1, 2...)\n• pKa PhOH = 10 ; pKb aniline ≈ 9,4\n\n**À retenir :**\n• Ortho/para si le substituant présent est donneur ; méta si attracteur"}
];
